...
CHERWELL_API_UPLOAD_ATTACHMENT = '/api/V1/uploadbusinessobjectattachment/filename/{filename}/\
    busobid/{busobid}/publicid/{publicid}/offset/{offset}/totalsize/{totalsize}'
